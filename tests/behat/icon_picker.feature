...
Feature: Teacher can allocate icons to tiles
  ...
  Scenario: Teacher can use icon picker to pick icons, and can rename section afterwards
    ...
    And I wait until the page is ready
    And I click on ".tile-icon[title=\"Refresh\"]" "css_element" in the "#icon_picker_modal_2" "css_element"
    And I wait until the page is ready
    ...
    And I wait until the page is ready
    And I click on ".tile-icon[title=\"Tasks\"]" "css_element" in the "#icon_picker_modal_4" "css_element"
    And I wait until the page is ready
