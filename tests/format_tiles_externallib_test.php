...
class format_tiles_externallib_testcase extends externallib_advanced_testcase {
    ...
    public function test_set_icon() {
        ...
        $result = format_tiles_external::set_icon($course->id, $sectionid, $newicon);
        $result = external_api::clean_returnvalue(format_tiles_external::set_icon_returns(), $result);
        // Check for 0 warnings.
        $this->assertEquals(true, $result);
        $this->assertEquals(false, $result['warnings']);
