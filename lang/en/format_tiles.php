...
$string['allowsubtilesview_desc'] = 'Allow use of a course setting which, if selected, within a tile shows non-label activities as sub tiles, instead of standard list';
...
$string['displaytitle_mod_doc'] = 'Word Document';
$string['displaytitle_mod_spreadsheet'] = 'Spreadsheet';
...
$string['activitycompletion_help'] = 'a Completion';
$string['hide'] = 'Hide';
...
$string['jsdeactivated'] = 'You have deactivated animated navigation on your account.  You can re-activate it using the navigation menu';
$string['jsreactivated'] = 'You have activated animated navigation on your account.  This may be quicker to use.  It requires Javascipt enabled.';
...
$string['hovercolour_descr'] = 'Cover which tiles will display on mouseover and which is used as a highlight colour in course "Heading" text where selected under Course Administration > Edit Settings';
$string['hovercolour'] = 'Tile hover colour';
$string['hovercolourname'] = 'Tile hover colour name';
