...
$string['embeddedurlerror'] = 'If the external website below refuses to connect in this window, use the new window button above right to visit the site directly';
...
$string['modalresources_desc'] = 'Launch these resources in modal window.  Note: if allowed here, URL activities will only open in a modal window if they are set to <em>Display: Embed</em> at the activity level.  Even then, they may be blocked by the website owner from showing embedded - see https://developer.mozilla.org/en-US/docs/Web/HTTP/Headers/X-Frame-Options';
